...
public class Regex {
	...
	public static void main(String[] args) {
		...
		System.out.println("The Number of Occurance o is : "+c);
	}
	
	
	static String str = "Java is a high-level, class-based, object-oriented programming language that is designed to have\r\n"
			+ "\r\n"
